import {CloseIcon} from "../ui/svgComponents";
import React from "react";

export const ModalStandard = ({ isShow, setIsShow, headerTitle, contentArea, isFit }) => {
    return isShow &&
        <div onClick={() => setIsShow(false)} className={`fixed top-0 left-0 z-[100] w-full h-full bg-black/50 flex justify-center items-center`}>
            {/* 컨텐츠 박스 */}
            <section className={`p-3 max-w-[500px] max-h-[500px] w-full ${isFit ? "h-fit" : " h-full"}`}>
                <div
