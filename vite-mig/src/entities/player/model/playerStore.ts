...
import type { Music, AccessedUserReq } from "@/shared/types";
...
interface PlayerStore {
  ...
  setSelectedCurrentMusic: (payload: Music) => void;
  setAccessedUserReq: (payload: AccessedUserReq | Record<string, never>) => void;
}
...
export const usePlayerStore = create<PlayerStore>((set) => ({
  ...
  savedMusic: [], // 저장된 음악
  submitMusic: [], // 신청곡 리스트
  selectedCurrentMusic: {} as Music, // 선택된 현재 음악정보
